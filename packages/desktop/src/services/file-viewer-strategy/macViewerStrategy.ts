...
/**
 * Spawn executable with MacOS "open" command with file paths as arguments.
 */
const macViewerStrategy: ViewerStrategy = async (executable, filePaths) => {
    const executableProcess = childProcess.spawn("open", ["-a", executable, ...filePaths], {
        detached: true,
...
export default macViewerStrategy;
