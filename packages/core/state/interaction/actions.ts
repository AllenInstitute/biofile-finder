 ...
 * PROCESS WARNING
 *
 * Intention to inform the user of a warning generated by the system or
 * a non-critical failure in a (potentially long-running) process
 */
export interface ProcessWarningAction {
    type: string;
    payload: StatusUpdate;
}
