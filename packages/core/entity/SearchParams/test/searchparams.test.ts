...
describe("SearchParams", () => {
    ...
    describe("getResourceNameFromSourceUrl", () => {
        // This is what the file extension is read from, so it must stay bare.
        ...
        it("ignores trailing slashes", () => {
            // Delta Lake tables are directories, so their URLs commonly end in "/"
    ...
    describe("getNameFromSourceUrl", () => {
        ...
        it("adds a suffix so two sources sharing a filename do not collide", () => {
            // The name becomes the DuckDB table name, so a bare last segment would
            // make "a.com/proj1/manifest.csv" and "b.com/proj2/manifest.csv" the
            // same source.
