...
// TODO: this is NOT always intended for JS?????? just when in python mode...
export function isInvalidRegex(pattern: string): boolean {
...
/**
 * PythonPanel component for generating Python scripts to inventory files.
 */
export default function PythonPanel(props: Props) {
    const {
        filePattern,
        onFilePatternChange,
        pathRegex,
