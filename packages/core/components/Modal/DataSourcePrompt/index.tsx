...
const DATA_SOURCE_DETAILS = [
    "The files must contain a 'file_path' column & must be unique by the 'file_path' column. Any other columns are optional and will be available as annotations to query by.",
    "The 'file_path' column should contain the full path to the file in a cloud storage. There are additional special columns that are optional, but will be handled as a special ",
    "case in the application. The 'uploaded' column should contain the date the file was uploaded to the cloud storage and be formatted as YYYY-MM-DD HH:MM:SS.Z where Z is a timezone offset. ",
    "The 'file_size' column should contain the size of the file in bytes. The 'file_name' column should be the file's name, the application will attempt to auto-generate this if it is not present. ",
