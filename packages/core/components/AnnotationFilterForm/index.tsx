...
import { NestedCondition } from "../../entity/FileFilter/NestedCombinationFilter";
...
export default function AnnotationFilterForm(props: AnnotationFilterFormProps) {
    ...
    // ------------------------------------------------------------------ //
    const isNestedAnnotation = props.annotation.isNested;
    ...
    function onApplyByField() {
        ...
        //         ),
        //         new FileFilter(props.annotation.name, "", FilterType.ANY),
        //     ])
        // );
    }
